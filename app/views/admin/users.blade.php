...
<div class="col-md-10">
    <div class="row admin-users-container">
        ...
        <div class="col-md-4">
            {{ Form::open(['url' => 'admin/validate-add-user', 'id' => 'add-user-form', 'class' => 'form-horizontal',
            'role' => 'form']) }}
            <div class="form-group">
                <div class="col-sm-12">
                    <input type="text" id="name" class="form-control" name="name" value="{{ e(Input::old('name')) }}"
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <input type="text" id="username" class="form-control" name="username"
                           value="{{ e(Input::old('username')) }}" placeholder="Username"/>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <input type="password" id="password" class="form-control" name="password"
                           value="{{ e(Input::old('password')) }}" placeholder="Password"/>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <input type="password" id="password-confirmation" class="form-control" name="password_confirmation"
                           value="{{ e(Input::old('password_confirmation')) }}" placeholder="Password Confirmation"/>
